...
// ── Search aliases: typed shorthand → substring to match against display names ──
const searchAliases = {
    'mlf':    'morgan le fay',
    'smerry': 's merry',
};
...
// ── Character list ────────────────────────────────────────────────────────────
// Format: 'Pc_InternalName_01'
// To add a character: append a new entry here and add a row to characterDatabase below.
...
// ── Character database ────────────────────────────────────────────────────────
// Columns: class, element, position, rarity
// class    : Knight | Archer | Wizard | Healer
// element  : Fire | Frost | Nature | Holy | Shock | Chaos | Radiance
// position : Front | Middle | Back
// rarity   : '3' | '4' | '5'
//
// To add a character: add one line below and one entry in rawCharacters above.

const characterDatabase = {
//  Name              class       element      position   rarity
